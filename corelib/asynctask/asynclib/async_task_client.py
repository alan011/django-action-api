...
from .defaults import ASYNCTASK_CLIENT_CONNECT_ADDR, ASYNCTASK_CLIENT_CONNECT_PORT
import json
...
class AsyncClient(object):
    def __init__(self, server_addr=None, server_port=None):
        self.server_addr = ASYNCTASK_CLIENT_CONNECT_ADDR if server_addr is None else server_addr
        self.server_port = ASYNCTASK_CLIENT_CONNECT_PORT if server_port is None else server_port
