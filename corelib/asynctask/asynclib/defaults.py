...
ASYNCTASK_CLIENT_CONNECT_ADDR = getattr(settings, 'ASYNCTASK_CLIENT_CONNECT_ADDR', _ASYNCTASK_BIND_ADDR)
ASYNCTASK_CLIENT_CONNECT_PORT = getattr(settings, 'ASYNCTASK_CLIENT_CONNECT_PORT', _ASYNCTASK_BIND_PORT)
