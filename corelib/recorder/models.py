...
class APICallingRecord(models.Model):
    ...
    # serializing field.s
    list_fields = ["id", "username", "api", "action", "post_data", "result", "message", "error_message", "operating_time_str"]
    detail_fields = list_fields
    search_fields = ["username", "api", "action", "post_data", "message", "error_message"]
